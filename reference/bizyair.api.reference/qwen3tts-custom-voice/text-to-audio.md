---
display_name: "通义Qwen3-TTS-文生语音-官方版"
category: "Text to Speech"
manufacturer: "硅基流动"
price: "100金币/次"
price_url: "https://bizyair.cn/modelzoo/qwen3tts-custom-voice/text-to-audio?tab=price"
benefit:
  rpd: 200
  rph: 60
  rpm: -1
description: |
  通义千问3代文生音频模型为阿里达摩院自研语音合成架构，人声韵律自然逼真，摆脱机械合成失真。支持多语种多方言，内置丰富音色库，可灵活调控语速、语调与情绪。长文本朗读流畅连贯、音质纯净，指令遵循力强，适配影视配音、广告旁白、有声读物等场景，为专业创作者提供高保真音频生成能力。
tags: ["自部署开源模型"]
---

# 通义Qwen3-TTS-文生语音-官方版

> **文生语音** | 厂商: 硅基流动 | 模型: `qwen3tts-custom-voice` | 类型: `text-to-audio`

通义千问3代文生音频模型为阿里达摩院自研语音合成架构，人声韵律自然逼真，摆脱机械合成失真。支持多语种多方言，内置丰富音色库，可灵活调控语速、语调与情绪。长文本朗读流畅连贯、音质纯净，指令遵循力强，适配影视配音、广告旁白、有声读物等场景，为专业创作者提供高保真音频生成能力。

💰 **价格**: 100金币/次  [查看详情](https://bizyair.cn/modelzoo/qwen3tts-custom-voice/text-to-audio?tab=price)
