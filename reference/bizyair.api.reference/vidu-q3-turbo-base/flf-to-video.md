---
display_name: "Vidu Q3.Turbo-首尾帧-渠道版"
category: "FLF to Video"
manufacturer: "生数科技"
price: "540P: 200 金币/1秒 | 720P: 300 金币/1秒 | 1080P: 350 金币/1秒"
price_url: "https://bizyair.cn/modelzoo/vidu-q3-turbo-base/flf-to-video?tab=price"
benefit:
  rpd: 200
  rph: 60
  rpm: -1
description: |
  生数科技Q3.Turbo渠道版首尾帧生视频模型，快速还原人物身形神态特征，动态衔接顺滑自然，生成效率大幅提升，画面保持稳定无扭曲漂移，主打快速出片批量创作，适配虚拟人像简易活化和日常人像短视频极速制作。
tags: ["Vidu"]
---

# Vidu Q3.Turbo-首尾帧-渠道版

> **首尾帧生视频** | 厂商: 生数科技 | 模型: `vidu-q3-turbo-base` | 类型: `flf-to-video`

生数科技Q3.Turbo渠道版首尾帧生视频模型，快速还原人物身形神态特征，动态衔接顺滑自然，生成效率大幅提升，画面保持稳定无扭曲漂移，主打快速出片批量创作，适配虚拟人像简易活化和日常人像短视频极速制作。

💰 **价格**: 540P: 200 金币/1秒 | 720P: 300 金币/1秒 | 1080P: 350 金币/1秒  [查看详情](https://bizyair.cn/modelzoo/vidu-q3-turbo-base/flf-to-video?tab=price)
...
async function submitTask() {
  const url = 'https://api.bizyair.cn/x/v1/modelzoo/tasks/openapi/vidu-q3-turbo-base/flf-to-video';
  const payload = {
    "first_frame_image": [
...
| 参数名 | 类型 | 必填 | 说明 |
| :--- | :--- | :--- | :--- |
| first_frame_image | array | 是 | 支持格式：png、jpeg、jpg、webp<br/>单文件大小上限：50.0 MB（52428800 byte）<br/>输入首帧图片，作为视频生成的起始帧 |
| last_frame_image | array | 是 | 支持格式：png、jpeg、jpg、webp<br/>单文件大小上限：50.0 MB（52428800 byte）<br/>输入尾帧图片，作为视频生成的结束帧 |
...
```json
{
  ...
  "outputs": {
    "videos": [
      "https://storage.bizyair.cn/outputs/UKebdOq3Y9UXeVfW.mp4"
    ]
  }
}
```
