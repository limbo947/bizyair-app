...
async function submitTask() {
  const url = 'https://api.bizyair.cn/x/v1/modelzoo/tasks/openapi/seedvr2/upscale/image';
  const payload = {
    "image": "",
    "resolution": 1080
  };
...
| 参数名 | 类型 | 必填 | 说明 |
| :--- | :--- | :--- | :--- |
| image | string | 是 | 单文件大小上限：10.0 MB（10485760 byte）<br/>图片最大高度：8192px<br/>最多上传数量：1<br/>图片大小最大 10 MB |
| resolution | number | 否 | ⟨bz_enum_json⟩["720","1080","1440","2160"]⟨/bz_enum_json⟩<br/>分辨率 |
