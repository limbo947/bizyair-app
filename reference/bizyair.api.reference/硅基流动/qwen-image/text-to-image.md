...
async function submitTask() {
  const url = 'https://api.bizyair.cn/x/v1/modelzoo/tasks/openapi/qwen-image/text-to-image';
  const payload = {
    "prompt": "一位年轻女性，自然随性的自拍风格，超高清写实人物生活照。她身着黄色碎花长袖上衣，长发自然垂落且略带波浪卷。画面背景为户外自然景色，近处有绿植，远处可见水域和山峦。自然柔和的阳光洒在人物脸上和身上，形成自然的光影效果，拍摄机位为人物手持设备的中景自拍视角，人物身体自然站立，展现出轻松自在的状态。角度自然，随手一拍的快照风格，不经意间的抓拍。",
...
| seed | number | 否 | 种子 |
| steps | number | 否 | 取值范围：6 ~ 50<br/>步数 |
| width | number | 否 | 取值范围：256 ~ 2048<br/>宽 |
| height | number | 否 | 取值范围：256 ~ 2048<br/>高 |
| guidance_scale | number | 否 | 取值范围：0.1 ~ 10<br/>步进：0.1<br/>guidance_scale |
...
```json
{
  ...
  "outputs": {
    "images": [
      "https://storage.bizyair.cn/outputs_examples/3xjxgylyc87uc_e85efe7025dfcad87a7ee2fb1e430585_ComfyUI_a6303b46_00001_.png"
    ]
  }
}
```
