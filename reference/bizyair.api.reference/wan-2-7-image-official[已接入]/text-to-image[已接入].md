---
display_name: "万相2.7-文生图-官方版"
category: "Text to Image"
manufacturer: "阿里"
price: "200 金币/1次"
price_url: "https://bizyair.cn/modelzoo/wan-2-7-image-official/text-to-image?tab=price"
benefit:
  rpd: 200
  rph: 60
  rpm: -1
description: |
  万相2.7图像官方版文生图模型，搭载升级核心渲染架构，文本语义理解精准到位。画面构图协调、色彩层次柔和细腻，兼容写实、二次元、简约艺术等多种风格，适合日常视觉配图、插画创作、社交素材设计等各类场景。
tags: ["万相图片"]
---

# 万相2.7-文生图-官方版

> **文生图** | 厂商: 阿里 | 模型: `wan-2-7-image-official` | 类型: `text-to-image`

万相2.7图像官方版文生图模型，搭载升级核心渲染架构，文本语义理解精准到位。画面构图协调、色彩层次柔和细腻，兼容写实、二次元、简约艺术等多种风格，适合日常视觉配图、插画创作、社交素材设计等各类场景。

💰 **价格**: 200 金币/1次  [查看详情](https://bizyair.cn/modelzoo/wan-2-7-image-official/text-to-image?tab=price)
...
async function submitTask() {
  const url = 'https://api.bizyair.cn/x/v1/modelzoo/tasks/openapi/wan-2-7-image-official/text-to-image';
  const payload = {
...
```json
{
  ...
  "outputs": {
    "images": [
      "https://storage.bizyair.cn/outputs/zh257gBfj5YORxly.png"
    ]
  }
}
```
