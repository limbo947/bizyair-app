---
display_name: "Vidu Q3.Turbo-图生视频-官方版"
category: "Image to Video"
manufacturer: "生数科技"
price: "启用推荐提示词时，额外收取一次320金币费用"
price_url: "https://bizyair.cn/modelzoo/vidu-q3-turbo-official/image-to-video?tab=price"
benefit:
  rpd: 200
  rph: 60
  rpm: -1
description: |
  生数科技Q3 Turbo官方版图生视频模型，面向专业创作与商业场景。原生支持1080P、16秒片段及音视频同步生成，Turbo架构使生成速度显著提升、成本降低约50%，帧间光影统一、主体运动流畅，适配多画幅比例，满足广告、短剧等快速出片需求。
tags: ["Vidu"]
---

# Vidu Q3.Turbo-图生视频-官方版

> **图生视频** | 厂商: 生数科技 | 模型: `vidu-q3-turbo-official` | 类型: `image-to-video`

生数科技Q3 Turbo官方版图生视频模型，面向专业创作与商业场景。原生支持1080P、16秒片段及音视频同步生成，Turbo架构使生成速度显著提升、成本降低约50%，帧间光影统一、主体运动流畅，适配多画幅比例，满足广告、短剧等快速出片需求。

💰 **价格**: 启用推荐提示词时，额外收取一次320金币费用  [查看详情](https://bizyair.cn/modelzoo/vidu-q3-turbo-official/image-to-video?tab=price)
...
async function submitTask() {
  const url = 'https://api.bizyair.cn/x/v1/modelzoo/tasks/openapi/vidu-q3-turbo-official/image-to-video';
  const payload = {
    "image": [
...
```json
{
  ...
  "outputs": {
    "videos": [
      "https://storage.bizyair.cn/outputs/M3ah6NfVe1Cz22D8.mp4"
    ]
  }
}
```
