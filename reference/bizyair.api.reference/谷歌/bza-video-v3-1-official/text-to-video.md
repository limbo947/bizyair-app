...
async function submitTask() {
  const url = 'https://api.bizyair.cn/x/v1/modelzoo/tasks/openapi/bza-video-v3-1-official/text-to-video';
  const payload = {
    "prompt": "Studio lighting macro shot of clear water droplets splashing onto a fresh green mint leaf, high-speed photography, frozen motion, clean white background, macro lens, hyper-detailed.",
    "negative_prompt": "",
    "aspect_ratio": "16:9",
    "resolution": "720p",
    "duration": 4,
...
```json
{
  ...
  "outputs": {
    "videos": [
      "https://bizyair-prod.oss-cn-shanghai.aliyuncs.com/outputs/8fab50bc-035e-4b56-adc6-b9b69fe05948.mp4"
    ]
  }
}
```
