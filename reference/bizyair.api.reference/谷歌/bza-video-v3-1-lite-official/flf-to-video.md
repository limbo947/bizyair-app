...
async function submitTask() {
  const url = 'https://api.bizyair.cn/x/v1/modelzoo/tasks/openapi/bza-video-v3-1-lite-official/flf-to-video';
  const payload = {
    "first_frame_url": [
      "https://bizyair-prod.oss-cn-shanghai.aliyuncs.com/inputs/20260607/RmQLogUJPQZOYWnyKw552AXDmYkQuvkK.jpg"
    ],
    "last_frame_url": [],
    "prompt": "The massive underwater gates slowly creek open, swirling currents of water and air bubbles rushing out from the dark abyss behind them. A school of glowing, bioluminescent fish suddenly darts through the opening into the foreground. The camera smoothly glides forward through the gateway, tracking into the mysterious deep blue ocean temple beyond.",
    "negative_prompt": "",
    "aspect_ratio": "16:9",
    "resolution": "720p",
    "duration": 4,
...
| resolution | string | 是 | ⟨bz_enum_json⟩["720p","1080p"]⟨/bz_enum_json⟩<br/>分辨率 |
...
```json
{
  ...
  "outputs": {
    "videos": [
      "https://bizyair-prod.oss-cn-shanghai.aliyuncs.com/outputs/6a49fe74-7643-4b29-9ff6-3eb56c75e3d7.mp4"
    ]
  }
}
```
