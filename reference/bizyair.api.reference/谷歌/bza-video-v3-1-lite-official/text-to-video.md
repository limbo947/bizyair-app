...
async function submitTask() {
  const url = 'https://api.bizyair.cn/x/v1/modelzoo/tasks/openapi/bza-video-v3-1-lite-official/text-to-video';
  const payload = {
    "prompt": "Drone shot of a lonely wooden cabin surrounded by a sea of blooming pink cherry blossom trees, soft morning sunlight piercing through the mist, petals gently falling in the wind, smooth cinematic panning shot, realistic, 8k.",
    "negative_prompt": "",
    "aspect_ratio": "16:9",
    "resolution": "720p",
    "duration": 4,
...
```json
{
  ...
  "outputs": {
    "videos": [
      "https://bizyair-prod.oss-cn-shanghai.aliyuncs.com/outputs/f8bab104-50f0-4606-9c13-d56deef3ba86.mp4"
    ]
  }
}
```
