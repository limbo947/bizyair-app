...
async function submitTask() {
  const url = 'https://api.bizyair.cn/x/v1/modelzoo/tasks/openapi/bza-video-v3-1-fast-official/flf-to-video';
  const payload = {
    "prompt": "The camera smoothly descends from the high aerial view, gliding lower toward the rooftops of the clustered houses. Smoke begins to curl gently from several chimneys, and streetlights below flicker on one by one as evening falls. A light breeze rustles the trees scattered between the buildings, adding subtle motion to the entire neighborhood.",
    "negative_prompt": "",
    "first_frame_url": [
      "https://bizyair-prod.oss-cn-shanghai.aliyuncs.com/inputs/20260607/xhluz5ZbXmZ2JzMaUXkPZj3WjTMI59O4.jpg"
    ],
    "last_frame_url": [],
    "aspect_ratio": "16:9",
    "resolution": "720p",
...
```json
{
  ...
  "outputs": {
    "videos": [
      "https://bizyair-prod.oss-cn-shanghai.aliyuncs.com/outputs/41a1a242-2561-48ea-bb62-02c66bda1871.mp4"
    ]
  }
}
```
