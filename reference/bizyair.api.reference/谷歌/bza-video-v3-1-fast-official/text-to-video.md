...
async function submitTask() {
  const url = 'https://api.bizyair.cn/x/v1/modelzoo/tasks/openapi/bza-video-v3-1-fast-official/text-to-video';
  const payload = {
    "prompt": "A giant ancient stone dragon statue carved into a colossal cliffside, waterfalls cascading from its eyes, a tiny traveler riding a horse standing at the base looking up, dark moody atmosphere, epic scale, camera slowly tilting up, photorealistic.",
    "negative_prompt": "",
    "aspect_ratio": "16:9",
    "resolution": "720p",
    "duration": 4,
...
```json
{
  ...
  "outputs": {
    "videos": [
      "https://bizyair-prod.oss-cn-shanghai.aliyuncs.com/outputs/15ee90cd-9166-43ad-aeeb-b06e230152d4.mp4"
    ]
  }
}
```
