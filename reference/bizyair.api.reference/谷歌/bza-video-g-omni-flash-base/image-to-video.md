...
async function submitTask() {
  const url = 'https://api.bizyair.cn/x/v1/modelzoo/tasks/openapi/bza-video-g-omni-flash-base/image-to-video';
  const payload = {
    "image_urls": [
      "https://bizyair-prod.oss-cn-shanghai.aliyuncs.com/inputs/20260528/L8XsbeqEOgNBtnJYb2q9uvDAg5RdF7Qc.jpg",
      "https://bizyair-prod.oss-cn-shanghai.aliyuncs.com/inputs/20260528/gnIx8OJbKuJpjBh1iRHyVAZHFeOrSthn.jpg",
      "https://bizyair-prod.oss-cn-shanghai.aliyuncs.com/inputs/20260528/pv1eEeCgdDZQaj6jKUL1ojVf545x4aIy.jpg"
    ],
    "prompt": "\"A cinematic mid-shot of a professional office setting with soft, warm natural sunlight streaming through a large window. A woman is gently cradling a fluffy dog, smiling as she talks to a man standing beside her. A hairless sphynx cat is perched on the office desk nearby, watching them curiously. The camera performs a slow, fluid tracking shot that circles the group to capture the interaction. High-end lifestyle commercial aesthetic, 8k, shallow depth of field, sharp focus on the characters' expressions.\"",
    "duration": "10",
    "resolution": "4k",
    "aspect_ratio": "16:9"
  };
...
| 参数名 | 类型 | 必填 | 说明 |
| :--- | :--- | :--- | :--- |
| image_urls | array | 是 | 单文件大小上限：10.0 MB（10485760 byte）<br/>最多上传数量：3<br/>最多支持 3 项图片，每张 10 MB 参考图片。支持 1 张单图生视频或 3 张参考图融合；不支持 2 张图。 |
...
```json
{
  ...
  "outputs": {
    "videos": [
      "https://storage.bizyair.cn/outputs_examples/wJLgXmaatqRjDEQc.mp4"
    ]
  }
}
```
