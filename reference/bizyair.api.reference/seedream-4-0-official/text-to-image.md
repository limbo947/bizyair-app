...
async function submitTask() {
  const url = 'https://api.bizyair.cn/x/v1/modelzoo/tasks/openapi/seedream-4-0-official/text-to-image';
  const payload = {
    "prompt": "古老宏伟图书馆，少女手持魔法书站在楼梯上，奇幻风格，柔和晨光从高窗洒入，书籍散发微光，细节丰富，唯美光影，8K 高清渲染",
    "size": "4K"
  };
...
```json
{
  ...
  "outputs": {
    "images": [
      "https://storage.bizyair.cn/outputs/R3PfTNhAnc97JAaO.jpeg"
    ]
  }
}
```
