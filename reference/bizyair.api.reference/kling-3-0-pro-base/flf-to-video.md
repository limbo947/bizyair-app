---
display_name: "可灵3.0.Pro-首尾帧-渠道版"
category: "FLF to Video"
manufacturer: "快手"
price: "true: 1050 金币/1秒 | false: 700 金币/1秒"
price_url: "https://bizyair.cn/modelzoo/kling-3-0-pro-base/flf-to-video?tab=price"
benefit:
  rpd: 200
  rph: 60
  rpm: -1
description: |
  可灵3.0.Pro渠道版首尾帧生视频模式，基于MVL架构，支持通过指定起始帧与结束帧约束画面运动轨迹，模型自动补全中间过渡内容，帧间衔接自然，原生支持同步音频输出，最大时长15秒。综合调用成本低于官方版。
tags: ["可灵"]
---

# 可灵3.0.Pro-首尾帧-渠道版

> **首尾帧生视频** | 厂商: 快手 | 模型: `kling-3-0-pro-base` | 类型: `flf-to-video`

可灵3.0.Pro渠道版首尾帧生视频模式，基于MVL架构，支持通过指定起始帧与结束帧约束画面运动轨迹，模型自动补全中间过渡内容，帧间衔接自然，原生支持同步音频输出，最大时长15秒。综合调用成本低于官方版。

💰 **价格**: true: 1050 金币/1秒 | false: 700 金币/1秒  [查看详情](https://bizyair.cn/modelzoo/kling-3-0-pro-base/flf-to-video?tab=price)
