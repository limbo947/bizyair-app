...
import { ResizableTextInput } from '../common/ResizableTextInput';
...
const createStyles = (colors) => ({
  ...
  addPresetConfirm: { backgroundColor: colors.primary, paddingVertical: Spacing.xs + 2, paddingHorizontal: Spacing.lg, borderRadius: Radius.sm, borderCurve: 'continuous' },
