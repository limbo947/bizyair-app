...
const styles = StyleSheet.create({
  ...
  historyCard: { flexDirection: 'row', backgroundColor: Colors.card, borderRadius: Radius.xs, marginBottom: Spacing.sm, overflow: 'hidden', ...Shadows.sm },
  ...
  historyThumbWrap: { marginLeft: 7, marginTop: 7, marginBottom: 7, borderRadius: 4, overflow: 'hidden' },
  historyThumb: { width: 88, height: '100%', resizeMode: 'cover', borderRadius: 4 },
  historyThumbPlaceholder: { width: 88, height: '100%', backgroundColor: Colors.bg, alignItems: 'center', justifyContent: 'center', borderRadius: 4 },
