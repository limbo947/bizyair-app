...
const styles = StyleSheet.create({
  ...
  historyThumbWrap: { marginLeft: 5, marginTop: 5, marginBottom: 5, alignSelf: 'stretch', justifyContent: 'center', alignItems: 'center', overflow: 'hidden' },
  historyThumb: { width: '100%', height: '100%', resizeMode: 'cover' },
