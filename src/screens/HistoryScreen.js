...
const styles = StyleSheet.create({
  ...
  historyCard: { flexDirection: 'row', backgroundColor: Colors.card, borderRadius: Radius.sm, marginBottom: Spacing.sm, overflow: 'hidden', ...Shadows.sm },
  ...
  historyThumbWrap: { width: 88, height: 72, marginVertical: Spacing.sm, marginLeft: 5 },
  historyThumb: { width: 88, height: 72, resizeMode: 'contain' },
  historyThumbPlaceholder: { width: 88, height: 72, backgroundColor: Colors.bg, alignItems: 'center', justifyContent: 'center' },
