...
const styles = StyleSheet.create({
  ...
  historyThumbWrap: { width: 94, height: 94, marginLeft: 7, marginVertical: 7 },
  historyThumb: { width: 94, height: 94, resizeMode: 'contain' },
  historyThumbPlaceholder: { width: 94, height: 94, backgroundColor: Colors.bg, alignItems: 'center', justifyContent: 'center' },
