---
display_name: "通用视觉G.3.1.Flash-Lite-视觉-官方版"
category: "Vision"
manufacturer: "谷歌"
price: "金币：1.75 / 1000 * prompt_tokens + 10.5 / 1000 * completion_tokens"
price_url: "https://bizyair.cn/modelzoo/bza-vision-g3-1-flash-lite-official/vision?tab=price"
benefit:
  rpd: 200
  rph: 60
  rpm: -1
description: |
  G.3.1.Flash-Lite 是该系列中成本效率最高的视觉语言模型，支持文本与图片的混合输入。低延迟、高吞吐，支持 1M Token 上下文，推理强度支持 minimal/low/medium/high 四档调节，适合有企业级 SLA 要求的高吞吐图文审核与视觉数据处理场景。
tags: ["通用视觉G"]
---

# 通用视觉G.3.1.Flash-Lite-视觉-官方版

> **视觉** | 厂商: 谷歌 | 模型: `bza-vision-g3-1-flash-lite-official` | 类型: `vision`

G.3.1.Flash-Lite 是该系列中成本效率最高的视觉语言模型，支持文本与图片的混合输入。低延迟、高吞吐，支持 1M Token 上下文，推理强度支持 minimal/low/medium/high 四档调节，适合有企业级 SLA 要求的高吞吐图文审核与视觉数据处理场景。

💰 **价格**: 金币：1.75 / 1000 * prompt_tokens + 10.5 / 1000 * completion_tokens  [查看详情](https://bizyair.cn/modelzoo/bza-vision-g3-1-flash-lite-official/vision?tab=price)
