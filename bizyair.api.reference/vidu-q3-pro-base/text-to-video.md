---
display_name: "Vidu Q3.Pro-文生视频-渠道版"
category: "Text to Video"
manufacturer: "生数科技"
price: "540P: 310 金币/1秒 | 720P: 660 金币/1秒 | 1080P: 700 金币/1秒"
price_url: "https://bizyair.cn/modelzoo/vidu-q3-pro-base/text-to-video?tab=price"
benefit:
  rpd: 200
  rph: 60
  rpm: -1
description: |
  生数科技Q3.Pro渠道版文生视频模型，精准解析文本语义生成连贯动态画面，人物场景还原度高。画面稳定无畸变漂移，生成效率高，适配多风格创作需求，兼顾写实与二次元画风，适合短视频、创意素材及日常轻量化视频制作。
tags: ["Vidu"]
---

# Vidu Q3.Pro-文生视频-渠道版

> **文生视频** | 厂商: 生数科技 | 模型: `vidu-q3-pro-base` | 类型: `text-to-video`

生数科技Q3.Pro渠道版文生视频模型，精准解析文本语义生成连贯动态画面，人物场景还原度高。画面稳定无畸变漂移，生成效率高，适配多风格创作需求，兼顾写实与二次元画风，适合短视频、创意素材及日常轻量化视频制作。

💰 **价格**: 540P: 310 金币/1秒 | 720P: 660 金币/1秒 | 1080P: 700 金币/1秒  [查看详情](https://bizyair.cn/modelzoo/vidu-q3-pro-base/text-to-video?tab=price)
...
async function submitTask() {
  const url = 'https://api.bizyair.cn/x/v1/modelzoo/tasks/openapi/vidu-q3-pro-base/text-to-video';
  const payload = {
...
| 参数名 | 类型 | 必填 | 说明 |
| :--- | :--- | :--- | :--- |
| prompt | string | 是 | 文本长度限制：1 - 2048<br/>视频生成提示词 |
...
| aspect_ratio | string | 否 | ⟨bz_enum_json⟩["16:9","9:16","4:3","3:4","1:1"]⟨/bz_enum_json⟩<br/>视频宽高比 |
| duration | number | 是 | 取值范围：3 ~ 15<br/>视频时长，单位秒 |
| audio | boolean | 否 | 是否使用音视频直出能力 |
...
```json
{
  ...
  "outputs": {
    "videos": [
      "https://storage.bizyair.cn/outputs/v2sFI4tOC2gjWZuV.mp4"
    ]
  }
}
```
