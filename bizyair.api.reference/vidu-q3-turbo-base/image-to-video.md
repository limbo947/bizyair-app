---
display_name: "Vidu Q3.Turbo-图生视频-渠道版"
category: "Image to Video"
manufacturer: "生数科技"
price: "540P: 200 金币/1秒 | 720P: 300 金币/1秒 | 1080P: 350 金币/1秒"
price_url: "https://bizyair.cn/modelzoo/vidu-q3-turbo-base/image-to-video?tab=price"
benefit:
  rpd: 200
  rph: 60
  rpm: -1
description: |
  生数科技Q3极速渠道版图生视频模型，面向广告行业与专业创作者。搭载Turbo推理架构，生成速度提升显著、成本降低约50%，支持1080P与16秒片段，原生音视频同步，帧间光影统一、主体运动流畅，适配多画幅比例，满足快速出片需求。
tags: ["Vidu"]
---

# Vidu Q3.Turbo-图生视频-渠道版

> **图生视频** | 厂商: 生数科技 | 模型: `vidu-q3-turbo-base` | 类型: `image-to-video`

生数科技Q3极速渠道版图生视频模型，面向广告行业与专业创作者。搭载Turbo推理架构，生成速度提升显著、成本降低约50%，支持1080P与16秒片段，原生音视频同步，帧间光影统一、主体运动流畅，适配多画幅比例，满足快速出片需求。

💰 **价格**: 540P: 200 金币/1秒 | 720P: 300 金币/1秒 | 1080P: 350 金币/1秒  [查看详情](https://bizyair.cn/modelzoo/vidu-q3-turbo-base/image-to-video?tab=price)
...
async function submitTask() {
  const url = 'https://api.bizyair.cn/x/v1/modelzoo/tasks/openapi/vidu-q3-turbo-base/image-to-video';
  const payload = {
    "image": [
...
| 参数名 | 类型 | 必填 | 说明 |
| :--- | :--- | :--- | :--- |
| image | array | 是 | 支持格式：png、jpeg、jpg、webp<br/>单文件大小上限：50.0 MB（52428800 byte）<br/>输入图片 |
...
```json
{
  ...
  "outputs": {
    "videos": [
      "https://storage.bizyair.cn/outputs/JIBG4XJfItQT6exZ.mp4"
    ]
  }
}
```
