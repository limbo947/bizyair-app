---
display_name: "通用视频X-图生视频-渠道版"
category: "Image to Video"
manufacturer: "grok"
price: "50金币/秒"
price_url: "https://bizyair.cn/modelzoo/bza-video-x-base/image-to-video?tab=price"
benefit:
  rpd: 200
  rph: 60
  rpm: -1
description: |
  通用视频X 的图生视频功能支持上传静帧图片，并将其转化为带有动态音效的视频片段。模型能够驱动静止画面中的元素进行流动，自动添加动态光影变化与平滑摄像机移动，同时提供多种配音版本可选。渠道版价格较官方版更经济，适用于老照片动态化、产品展示视频及社交媒体趣味动画等场景。
tags: ["通用视频X"]
---

# 通用视频X-图生视频-渠道版

> **图生视频** | 厂商: grok | 模型: `bza-video-x-base` | 类型: `image-to-video`

通用视频X 的图生视频功能支持上传静帧图片，并将其转化为带有动态音效的视频片段。模型能够驱动静止画面中的元素进行流动，自动添加动态光影变化与平滑摄像机移动，同时提供多种配音版本可选。渠道版价格较官方版更经济，适用于老照片动态化、产品展示视频及社交媒体趣味动画等场景。

💰 **价格**: 50金币/秒  [查看详情](https://bizyair.cn/modelzoo/bza-video-x-base/image-to-video?tab=price)
